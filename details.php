			...
			<div class="details_big_box">
				<div class='proddet'>
					...
					<div class="specificationss"> Description: <span class="blue"><?php echo $row['prodescription'];?></span><br /><br />
						...
						Available to: <span class="blue">The ICT University</span><br /><br />
				...
				<?php
							...
							echo"</span>
								...
								&nbsp&nbsp Highest Bid: <span class='blue'>CFA";?><?php echo $highbid;?><?php echo"</span><br /><br />
								...
								<?php echo'</span><br /><br />
									<form method = "post" action="bidconfirm.php?id='.$prodid.'" id="logins-form" class="logins-form">
										...
										&nbsp&nbsp <strong>CFA</strong><input type="text" name="bidamount">
										<input type="submit" value="Place Bid" name="submit">
									</form>
								&nbsp&nbsp <span class="blue"><strong>';
								echo "<span class='blue'>(Enter Price higher than CFA".$highbid.")</span>";
