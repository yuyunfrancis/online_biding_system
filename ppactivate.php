...
<script type='text/javascript'>
	...
	<?php logform(); ?>
      ...
      <div class="border_box">
        ...
        <div class="product_img"><a href="login.php"><img src="images/p2.gif" alt="" border="0" /></a></div>
        <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>
      </div>
      <div class="title_box">Manufacturers</div>
      <ul class="left_menu">
        <li class="odd"><a href="login.php">Sony</a></li>
        <li class="even"><a href="login.php">Samsung</a></li>
        <li class="odd"><a href="login.php">Daewoo</a></li>
        <li class="even"><a href="login.php">LG</a></li>
        <li class="odd"><a href="login.php">Fujitsu Siemens</a></li>
        <li class="even"><a href="login.php">Motorola</a></li>
        <li class="odd"><a href="login.php">Phillips</a></li>
        <li class="even"><a href="login.php">Beko</a></li>
      </ul>
      <div class="banner_adds"> <a href="login.php"><img src="images/bann1.jpg" alt="" border="0" /></a> </div>
    </div>
